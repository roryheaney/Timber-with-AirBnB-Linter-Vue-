...
// small option also
// function fancySquaresSetPreviewImage($data, $post, $request){
//     $_data = $data->data;
...
//     $acfImageField = get_field('preview_image_post', get_the_ID());
//     $acfImageField = wp_get_attachment_image_src( $acfImageField, 'medium_large' );

//     $_data['preview_img'] = $acfImageField[0];
//     // $_data['fi_medium'] = $thumbnailMedium[0];
//     $data->data = $_data;

//     return $data;
// }
// add_filter('rest_prepare_post', 'fancySquaresSetPreviewImage', 10, 3);